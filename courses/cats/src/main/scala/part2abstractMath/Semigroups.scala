...
object Semigroups {
  ...
  // type class that provide a combination function between elements
  ...
  val stringCombination = naturalStringSemigroup.combine("I love ", "Cats") // concat
  ...
  def main(args: Array[String]): Unit = {
    ...
    // compiler will produce an implicit Semigroup[Option[Int]] -> will produce another option with the summed up elements
    // compiler will produce an implicit Semigroup[Option[String]] -> will produce another option with the concatenated elements

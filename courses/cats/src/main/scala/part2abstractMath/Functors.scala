...
object Functors {
  ...
  // todo 2: write a shorter do10x method by using extension methods
//  def do10xShorter[F[_]](container: F[Int])(implicit functor: Functor[F]): F[Int] = container.map(_ * 10)
  def do10xShorter[F[_] : Functor](container: F[Int]): F[Int] = container.map(_ * 10) // equivalent
  ...
  def main(args: Array[String]): Unit = {
    ...
    println(do10x[Tree](Branch(30, Leaf(10), Leaf(20)))) // equivalent
    println(do10x(Tree.branch(30, Leaf(10), Leaf(20)))) // equivalent (adds smart constructor)
    println(do10x(Tree.branch(30, Tree.leaf(10), Tree.leaf(20)))) // equivalent (adds smart constructors)
    println(do10xShorter(Tree.branch(30, Tree.leaf(10), Tree.leaf(20)))) // equivalent (adds smart constructors)

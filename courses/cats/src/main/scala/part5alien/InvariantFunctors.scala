...
object InvariantFunctors {
  ...
  /*
    how can we support this cypher for int, doubles, Option[String]?
   */
  ...
  // todo 2: generalize this pattern. if you have a Crypto[T] => Crypto[Option[T]] if you have a Monooid[T] in scope
  ...
  trait MyFunctor[W[_]] extends MyInvariant[W] { // "covariant" functor (most popular, usually just 'functor')

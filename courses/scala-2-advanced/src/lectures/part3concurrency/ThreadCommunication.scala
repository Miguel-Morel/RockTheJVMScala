    ...
    val consumer = new Thread(() => {
      ...
      while(true) {
        buffer.synchronized {
          ...
          // producer, there's empty space available
          buffer.notify()
    ...
    val producer = new Thread(() => {
      ...
      while(true) {
        buffer.synchronized {
          ...
          // consumer, there are elements available
          buffer.notify()
...
//  multiProdCons(3, 6)
  ...
  /*
    ...
    2. create a deadlock: when multiple threads block each other and they cannot continue
    3. create a livelock: when multiple threads yield execution to each other and they cannot continue
   */

...
object TuplesAndMaps extends App {
  ...
  val aPhoneBook = Map(("Jim", 555), "Daniel" -> 789, ("JIM", 9000)).withDefaultValue(-1)
  println(aPhoneBook)
  ...
  /*
    1. what would happen if there were two original entries "Jim" -> 555 and "JIM" -> 900?

      !!! careful with mapping keys. make sure there are no overlays like in this instance where there is no lowercase JIM
      Map(Jim -> 555, Daniel -> 789, JIM -> 9000, Mary -> 678)
      Map(jim -> 9000, daniel -> 789)

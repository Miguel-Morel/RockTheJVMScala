...
object Http4s extends IOApp.Simple {
  ...
  object CourseRepository {
    ...
    private val catsEffectCourse = Course(
      "cd318a2c-55ec-4b94-83ae-000e62bea676",
      "rock the jvm ultimate scala course",
      2026,
      List("Miguel", "Master Yoda"),
      "Martin Odersky"
    )
  ...
  // essential GET REST endpoints
  // GET localhost:8080/courses?instructor=Martin%20Odersky&year=2026
  // GET localhost:8080/courses/cd318a2c-55ec-4b94-83ae-000e62bea676/students
